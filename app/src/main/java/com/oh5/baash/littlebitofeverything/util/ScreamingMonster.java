...
import com.oh5.baash.littlebitofeverything.R;
...
public class ScreamingMonster {
    ...
    public void run(){
        ...
        iv.setImageResource(R.drawable.screaming_monster);
        ...
        TranslateAnimation animation = new TranslateAnimation(layout.getWidth() + 10, image_end_x, image_top, image_top);
